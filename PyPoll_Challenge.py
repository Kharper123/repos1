...
candidate_options= ["Diana DeGette", "Charles Casper Stockham", "Raymon Anthony Doane"]
candidate_votes = {"Diana DeGette": 0, "Charles Casper Stockham": 0, "Raymon Anthony Doane": 0}
...
#####################
    ...
    for county_name in county_votes:
        ...
        # Print each county  count and percentage to the
        # terminal.
    ...
    winning_county_summary = (
        ...
        f"Winning Percentage: {winning_percentage_county:.1f}%\n"
        f"-------------------------\n")
